...
// read and write a single number (PULSE's best Gauntlet score) in the browser's
...
// value to a file instead; see the pong-storage crate.
(function () {
    var KEY = "pulse_best_gauntlet";
    function register(importObject) {
        importObject.env.pulse_storage_get = function () {
            try {
        ...
        importObject.env.pulse_storage_set = function (value) {
            try {
